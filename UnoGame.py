...
def showDevinfo ():
        print("Lijst met speelbare kaarten: "+ ", ".join(currentlyplayable))
        print("Stapel op de tafel: "+ ", ".join(pile))
        print("Jij: "+ ", ".join(playerhand))
        print("De andere speler: " + ", ".join(aihand))
...
def playerDraws():
    ...
    if not currentlyplayable:
        ...
        del completeddeck[0]
        print("Geen kaarten om te spelen, Pak er 1 van de stapel")
        for x in colors:
...
def aiTurn():
    ...
    print("De hand de andere speler bestaat uit "+ str(len(aihand)) +" kaarten")
    if len(aihand) == 0:
        endofthegame = True
    if len(pile) != 1:
        if "+2" in pile[-1]:
            print("de andere speler moet 2 kaarten pakken door jou +2 kaart")
            for x in range(0,2):
                nextcard = completeddeck[0]
                del completeddeck[0]
                aihand.append(nextcard)
        elif nextplayerskips > 0:
            print("De andere moest zijn beurt overslaan door jou sla-beurt-over/omkeer kaart")
            nextplayerskips = int(nextplayerskips) - 1
        elif "neem vier" in pile[-1]:
            print("Andere speler moet 4 kaarten pakken door jou neem vier kaart")
            for x in range(0,4):
                nextcard = completeddeck[0]
                del completeddeck[0]
                aihand.append(nextcard)
    ...
    if nextplayerskips == 0:
        ...
        print("Andere speler moest zijn beurt overslaan door jou sla-beurt-over/omkeer kaart")
        nextplayerskips = int(nextplayerskips) - 1
...
def playerTurn():
    ...
    if nextplayerskips == 0 and endofthegame == False and len(pile) != 1:
        if "+2" in pile[-1]:
            print("Jij moet 2 kaarten pakken door de +2 kaart die de andere speler heeft gespeeld")
            for x in range(0,2):
                nextcard = completeddeck[0]
                del completeddeck[0]
                playerhand.append(nextcard)
        elif "neem vier" in pile[-1]:
            print("je moet 4 kaarten pakken door de andere speler moest de kaart neem vier kaart")
            for x in range (0,4):
                nextcard = completeddeck[0]
                del completeddeck[0]
                playerhand.append(nextcard)
